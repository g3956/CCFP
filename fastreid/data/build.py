...
_root = '/home/wenhang/data'

collateFn = samplers.NormalCollateFn()
...
def build_reid_train_loader(cfg, mapper=None, **kwargs):
    ...
    if cfg.DATALOADER.PK_SAMPLER:
        ...
        elif cfg.DATALOADER.BiCAMERA_WAY:
            data_sampler = samplers.RandomBiCameraSampler(train_set.img_items, mini_batch_size, num_ids)
        else:
            data_sampler = samplers.RandomIdentityCameraSampler(train_set.img_items, mini_batch_size, num_instance)
    else:
