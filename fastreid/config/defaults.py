...
_C.MODEL.BACKBONE.META = False

# ---------------------------------------------------------------------------- #
# REID HEADS options
# ---------------------------------------------------------------------------- #
_C.MODEL.HEADS = CN()
_C.MODEL.HEADS.FORWARD = False
_C.MODEL.HEADS.CAMERA_HEAD = 'simple'
...
# ---------------------------------------------------------------------------- #
_C.MODEL.Positional_encoder = CN()
_C.MODEL.Positional_encoder.position_embedding = 'learned'
...
_C.DATALOADER.BiCAMERA_WAY = False
# Number of instance for each person
_C.DATALOADER.NUM_INSTANCE = 4
_C.DATALOADER.NUM_WORKERS = 8

_C.DATALOADER.NUM_CAMERA = 6
_C.DATALOADER.NUM_ID = 16
