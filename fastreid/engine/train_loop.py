...
import numpy as np
import torch
from fastreid.utils.my_tools import get_class2camera
...
class SimpleTrainer(TrainerBase):
    ...
    def __init__(self, model, data_loader, optimizer, num_classes, cfg):
        """
        Args:
        ...
        self.class2camera = get_class2camera(self.model, self.data_loader, num_classes)
    ...
    def run_step(self):
        ...
        loss_dict = self.model(data, self.class2camera, self.iter)
